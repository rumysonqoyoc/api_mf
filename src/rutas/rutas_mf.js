...
import {eess_micro, get_ini, micro_redes, por_micro_eess, por_micro_programa, por_producto, por_producto_micro, por_programa, por_programa_micro, productos, programas, sub_productos} from '../controlador/ctrl_mf.js';
const router=Router();
